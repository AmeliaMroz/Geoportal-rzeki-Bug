...
var format_AnalizajakociowaVMapiSentinel_1 = new ol.format.GeoJSON();
var features_AnalizajakociowaVMapiSentinel_1 = format_AnalizajakociowaVMapiSentinel_1.readFeatures(json_AnalizajakociowaVMapiSentinel_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_AnalizajakociowaVMapiSentinel_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_AnalizajakociowaVMapiSentinel_1.addFeatures(features_AnalizajakociowaVMapiSentinel_1);
var lyr_AnalizajakociowaVMapiSentinel_1 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_AnalizajakociowaVMapiSentinel_1, 
                style: style_AnalizajakociowaVMapiSentinel_1,
                popuplayertitle: 'Analiza jakościowa - VMap i Sentinel',
                interactive: true,
    title: 'Analiza jakościowa - VMap i Sentinel<br />\
    <img src="styles/legend/AnalizajakociowaVMapiSentinel_1_0.png" /> -93 - -23<br />\
    <img src="styles/legend/AnalizajakociowaVMapiSentinel_1_1.png" /> -23 - 0<br />\
    <img src="styles/legend/AnalizajakociowaVMapiSentinel_1_2.png" /> 0 - 7<br />\
    <img src="styles/legend/AnalizajakociowaVMapiSentinel_1_3.png" /> 7 - 30<br />\
    <img src="styles/legend/AnalizajakociowaVMapiSentinel_1_4.png" /> 30 - 100<br />' });
var format_AnalizajakociowaWIGiVMap_2 = new ol.format.GeoJSON();
var features_AnalizajakociowaWIGiVMap_2 = format_AnalizajakociowaWIGiVMap_2.readFeatures(json_AnalizajakociowaWIGiVMap_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_AnalizajakociowaWIGiVMap_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_AnalizajakociowaWIGiVMap_2.addFeatures(features_AnalizajakociowaWIGiVMap_2);
var lyr_AnalizajakociowaWIGiVMap_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_AnalizajakociowaWIGiVMap_2, 
                style: style_AnalizajakociowaWIGiVMap_2,
                popuplayertitle: 'Analiza jakościowa - WIG i VMap',
                interactive: true,
    title: 'Analiza jakościowa - WIG i VMap<br />\
    <img src="styles/legend/AnalizajakociowaWIGiVMap_2_0.png" /> -93 - -23<br />\
    <img src="styles/legend/AnalizajakociowaWIGiVMap_2_1.png" /> -23 - 0<br />\
    <img src="styles/legend/AnalizajakociowaWIGiVMap_2_2.png" /> 0 - 7<br />\
    <img src="styles/legend/AnalizajakociowaWIGiVMap_2_3.png" /> 7 - 30<br />\
    <img src="styles/legend/AnalizajakociowaWIGiVMap_2_4.png" /> 30 - 100<br />' });
...
lyr_OpenStreetMap_0.setVisible(true);lyr_AnalizajakociowaVMapiSentinel_1.setVisible(true);lyr_AnalizajakociowaWIGiVMap_2.setVisible(true);lyr_Zasiggdzierzekapynazawsze_3.setVisible(true);lyr_Zasiggdzierzekapynakiedykolwiek_4.setVisible(true);lyr_RzekazmapyarchiwalnejWIG_5.setVisible(true);lyr_RzekazbazyVMap_6.setVisible(true);lyr_RzekazezdjciasatelitarnegoSentinel_7.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_AnalizajakociowaVMapiSentinel_1,lyr_AnalizajakociowaWIGiVMap_2,lyr_Zasiggdzierzekapynazawsze_3,lyr_Zasiggdzierzekapynakiedykolwiek_4,lyr_RzekazmapyarchiwalnejWIG_5,lyr_RzekazbazyVMap_6,lyr_RzekazezdjciasatelitarnegoSentinel_7];
lyr_AnalizajakociowaVMapiSentinel_1.set('fieldAliases', {'Id': 'Id', 'GRID_ID': 'GRID_ID', 'PERCENTAGE': 'PERCENTAGE', 'PERCENTA_1': 'PERCENTA_1', 'PERCENTA_2': 'PERCENTA_2', 'Shape_Leng': 'Shape_Leng', 'Shape_Area': 'Shape_Area', 'SENTINEL_V': 'PROCENT POKRYCIA', 'VMAP_WIG1': 'VMAP_WIG1', });
lyr_AnalizajakociowaWIGiVMap_2.set('fieldAliases', {'Id': 'Id', 'GRID_ID': 'GRID_ID', 'PERCENTAGE': 'PERCENTAGE', 'PERCENTA_1': 'PERCENTA_1', 'PERCENTA_2': 'PERCENTA_2', 'Shape_Leng': 'Shape_Leng', 'Shape_Area': 'Shape_Area', 'SENTINEL_V': 'SENTINEL_V', 'VMAP_WIG1': 'PROCENT POKRYCIA', });
...
lyr_AnalizajakociowaVMapiSentinel_1.set('fieldImages', {'Id': 'TextEdit', 'GRID_ID': 'TextEdit', 'PERCENTAGE': 'TextEdit', 'PERCENTA_1': 'TextEdit', 'PERCENTA_2': 'TextEdit', 'Shape_Leng': 'TextEdit', 'Shape_Area': 'TextEdit', 'SENTINEL_V': 'TextEdit', 'VMAP_WIG1': 'TextEdit', });
lyr_AnalizajakociowaWIGiVMap_2.set('fieldImages', {'Id': 'TextEdit', 'GRID_ID': 'TextEdit', 'PERCENTAGE': 'TextEdit', 'PERCENTA_1': 'TextEdit', 'PERCENTA_2': 'TextEdit', 'Shape_Leng': 'TextEdit', 'Shape_Area': 'TextEdit', 'SENTINEL_V': 'TextEdit', 'VMAP_WIG1': 'TextEdit', });
...
lyr_AnalizajakociowaVMapiSentinel_1.set('fieldLabels', {'Id': 'hidden field', 'GRID_ID': 'hidden field', 'PERCENTAGE': 'hidden field', 'PERCENTA_1': 'hidden field', 'PERCENTA_2': 'hidden field', 'Shape_Leng': 'hidden field', 'Shape_Area': 'hidden field', 'SENTINEL_V': 'inline label - visible with data', 'VMAP_WIG1': 'hidden field', });
lyr_AnalizajakociowaWIGiVMap_2.set('fieldLabels', {'Id': 'hidden field', 'GRID_ID': 'hidden field', 'PERCENTAGE': 'hidden field', 'PERCENTA_1': 'hidden field', 'PERCENTA_2': 'hidden field', 'Shape_Leng': 'hidden field', 'Shape_Area': 'hidden field', 'SENTINEL_V': 'hidden field', 'VMAP_WIG1': 'inline label - visible with data', });
